...
<div class="container">
	<div class="center-align">
      	...
      	<p class="white-text">Remove Pairings</p>
...
$stmt = mysqli_prepare($conn, "UPDATE Clients set wearableID = ?");
...
echo ('<p class="white-text">IDs Unpaired. Redirecting back to input page...</p>');
