...
<div class="container">
	<div class="center-align">
      	...
      	<p class="white-text">ID creation</p>
...
if(isset($_POST['newID']) && $_POST['newID'] != 0) {
	$newID = $_POST['newID'];
	...
	$stmt = mysqli_prepare($conn, "INSERT INTO IDs (wearableID)
	VALUES (?)");
	...
	echo ('<p class="white-text">ID added. Redirecting back to input page...</p>');
